...
@section('content')
    ...
    <div class="mt-3">
        <div class="mt-3 d-flex flex-row">
            <p class="me-3"><a href="{{ route('late.create') }}" class="fw-bold text-decoration-none">tambah</a></p>

            <p class="me-3"><a href="{{ route('late.index') }}" class="fw-bold text-decoration-none">Data Keterlambatan</a></p>
        </div>  
        ...
        <form action="{{ route('late.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="datetime-local" class="form-control" id="date_time" name="date_time" value="{{ old('date_time_lite') }}">
                </div>
            </div>
