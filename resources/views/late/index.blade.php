...
@section('content')
    ...
    <div class=" justify-content-end">
        <div class="container" style="max-width: 80%; margin: 0 50px 0 0">
            ...
            <a >/</a>
            <a href="{{ route('late.excel') }}" style="color: black" class="btn btn-secondary mb-3" >Export Data Keterlambatan</a>
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="{{ route('late.index') }}" style="color: black">Keseluruhan Data</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('late.rekap') }}" style="color: black">Rekapitulasi Data</a>
        </li>
    </ul>
