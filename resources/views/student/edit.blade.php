...
<div class="card mt-3">
    <div class="card-body p-5">
        <div class="justify-content-start jumbotron py-3" style="line-height: 5px; padding-bottom:30px;">
            ...
            <a href="/dashboard" style="color: black;" class="btn btn-primary ml-5">Home </a>
            <a href="{{route('student.index')}}" style="color: black;" class="btn btn-primary ml-5">Data Siswa </a> 
            <a href="{{route('student.create')}}" style="color: black;" class="btn btn-secondary ml-5">Edit Data Siswa </a> 
          </div>
          <div class="mt-3">
